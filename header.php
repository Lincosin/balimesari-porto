...
<body>
<nav id="navbar" class="navbar fixed -mt-16 inset-x-0 bg-transparent backdrop-filter  z-50 transition-all duration-300">
    ...
    <div class="flex space-x-4">
        <a href="index.php" class="nav-link text-white  hover:text-[#CCA300] px-3 py-2 rounded-md text-sm font-medium">Home</a>
        <a href="about.php" class="nav-link text-white  hover:text-[#CCA300] px-3 py-2 rounded-md text-sm font-medium">About</a>
        <a href="Packages.php" class="nav-link text-white  hover:text-[#CCA300] px-3 py-2 rounded-md text-sm font-medium">Packages</a>
        <a href="gallery.php" class="nav-link text-white  hover:text-[#CCA300] px-3 py-2 rounded-md text-sm font-medium">Gallery</a>
        <a href="contact.php" class="nav-link text-white  hover:text-[#CCA300] px-3 py-2 rounded-md text-sm font-medium">Contact Us</a>
    </div>
</div>
        </div>
    </div>
    ...
    <script>
            ...
            if (window.scrollY > 50) {
                ...
                navbar.classList.add("bg-solid-white");
            } else {
                navbar.classList.remove("bg-solid-white");
